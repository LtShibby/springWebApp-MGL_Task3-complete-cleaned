...
@Configuration
@EnableJpaRepositories(basePackages = "com.MGL_Task3.repository", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
...
public class JpaConfiguration {
	...
	factoryBean.setPackagesToScan(new String[] { "com.MGL_Task3.model" });
